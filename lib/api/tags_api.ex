defmodule Zendesk.TagsApi do
  ...
  def set_tags(account, ticket_id: ticket_id, tags: tags) do
    perform_tag_request(account,
      verb: :post,
      endpoint: @tags_for_ticket,
      id: ticket_id,
      tags: tags
    )
  end
  ...
  def set_tags(account, user_id: user_id, tags: tags) do
    perform_tag_request(account, verb: :post, endpoint: @tags_for_user, id: user_id, tags: tags)
  end
  ...
  def update_tags(account, ticket_id: ticket_id, tags: tags) do
    perform_tag_request(account, verb: :put, endpoint: @tags_for_ticket, id: ticket_id, tags: tags)
  end
  ...
  def update_tags(account, user_id: user_id, tags: tags) do
    perform_tag_request(account, verb: :put, endpoint: @tags_for_user, id: user_id, tags: tags)
  end
  ...
  def delete_tags(account, user_id: user_id, tags: tags) do
    perform_tag_request(account, verb: :delete, endpoint: @tags_for_user, id: user_id, tags: tags)
  end
